...
Let us investigate the behaviour of light cones at this particular surface.
Imagine a null ray closing in on $r_S$ at $\td \Omega =0$
\begin{align} 
...
To cut the derivation\cite{Carroll} short we will introduce the Kruskal coordinates $\left\{T,R,\theta ,\phi \right\}$ which relate to $\left\{r,t,\theta ,\phi \right\}$ via 
\begin{align} 
...
\begin{align} 
  \diff[]{R}{T} &= \pm 1
.\end{align} 
This will therefore also hold at $r=r_S$; the event horizon of the black hole is therefore a null hypersurface.
...
\begin{enumerate}[label=\alph*)]
  \item show one never reaches the event horizon from an outside observer.
  \item show the observer who traveles to the event horizon does reach it in finite time.
  \item formal definition of the event horizon as a null hypersurface with a singularity within.
