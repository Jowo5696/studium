...
\begin{align} 
  l^2\equiv l^\mu l_\mu  &= l^\mu g_{\mu \nu }l^\nu =g^{\mu \rho }\partial_\rho Sg_{\mu \nu }g^{\nu \sigma }\partial_\sigma S=g^{\mu \rho }\partial_\rho S\partial_\mu S\\
               ...
               &= \left(1-\dfrac{2GM}{r}\right)(1)^2
,\end{align} 
where
\begin{align} 
  \left. l^\mu l_\mu \right|_{r=2GM}=0
.\end{align} 
...
\noindent $G^2M^2=a^2$: This is the extreme Kerr black hole.\\
...
Another important surface is when
\begin{align} 
...
\begin{align} 
  ...
  \left.K^2\right|_{r=r_+^E}=\dfrac{2GM\left(GM+\sqrt{G^2M^2-a^2\cos ^2\theta }\right)}{2G^2M^2+2GM\sqrt{G^2M^2-a^2\cos ^2\theta }}-1=0
\end{align} 

\begin{align} 
  | | K| | =0\text{ stationary limit}\qquad | | K| | <0\text{ ergosphere}\qquad | |K| |=1\text{ at infinity}
,\end{align} 
where $| | K| | =g(K,K)$.
...
It is entirely possible for the energy to be negative since the Killing vector $K=\partial_t$ is timelike inside the ergophere.
