...
\begin{align} 
  ...
  \intertext{now $\Omega =a\left(2G^2M^2+2GM\sqrt{G^2M^2-a^2}\right)^{-1}$ and the surface gravity $\kappa =\tfrac{\sqrt{G^2M^2-a^2}}{2GM(GM+\sqrt{G^2M^2-a^2})}=\tfrac{\Omega \sqrt{G^2M^2-a^2}}{a}$}
