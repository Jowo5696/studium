...
\todo{Hawking area theorem}
Therefore, Bekenstein introduced an entropy for black holes, which is proportional to the black hole's area $A$, 
\begin{align} 
  S_{bh}\equiv S_{b.h.} &= \eta k_BL_p^{-2}A
,\end{align} 
where $\eta $ is a constant number of order unity, $k_B$ is the Boltzmann constant, $L_p$ is the Planck length.
