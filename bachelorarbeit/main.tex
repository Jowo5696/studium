...
\begin{align} 
  ...
  \Leftrightarrow t\indices{^\nu }\dfrac{1}{2}\left(t\indices{_\rho }\nabla \indices{_\lambda }\nabla \indices{_\nu }t\indices{_\mu }+t\indices{_\rho }\nabla \indices{_\nu }\nabla \indices{_\lambda }t\indices{_\mu }-t\indices{_\rho }\nabla \indices{_\nu }\nabla \indices{_\lambda }t\indices{_\mu }-t\indices{_\lambda }\nabla \indices{_\rho }\nabla \indices{_\nu }t\indices{_\mu }\right) &= a\\
  \Leftrightarrow t\indices{^\nu }\dfrac{1}{2}\left(t\indices{_\rho }R\indices{_\lambda _\nu _\mu ^\sigma }t\indices{_\sigma }+t\indices{_\rho }\nabla \indices{_\nu }\nabla \indices{_\lambda }t\indices{_\mu }-t\indices{_\lambda }\nabla \indices{_\rho }\nabla \indices{_\nu }t\indices{_\mu }+t\indices{_\lambda }\nabla \indices{_\nu }\nabla \indices{_\rho }t\indices{_\mu }-t\indices{_\lambda }\nabla \indices{_\nu }\nabla \indices{_\rho }t\indices{_\mu }\right) &= a\\
  \Leftrightarrow t\indices{^\nu }\dfrac{1}{2}\left(t\indices{_\rho }R\indices{_\lambda _\nu _\mu ^\sigma }t\indices{_\sigma }+t\indices{_\rho }\nabla \indices{_\nu }\nabla \indices{_\lambda }t\indices{_\mu }-t\indices{_\lambda }\nabla \indices{_\nu }\nabla \indices{_\rho }t\indices{_\mu }-t\indices{_\lambda }R\indices{_\rho _\nu _\mu ^\sigma }t\indices{_\sigma }\right) &= a\\
  \Leftrightarrow t\indices{^\nu }\dfrac{1}{2}\left(t\indices{_\rho }R\indices{_\lambda _\nu _\mu ^\sigma }t\indices{_\sigma }-t\indices{_\rho }\nabla \indices{_\nu }\nabla \indices{_\mu }t\indices{_\lambda }+t\indices{_\lambda }\nabla \indices{_\nu }\nabla \indices{_\mu }t\indices{_\rho }-t\indices{_\lambda }R\indices{_\rho _\nu _\mu ^\sigma }t\indices{_\sigma }\right) &= a\\
  \Leftrightarrow t\indices{^\nu }t\indices{_[_\rho }R\indices{_\lambda _]_\nu _\mu ^\sigma }t\indices{_\sigma }+t\indices{^\nu }\dfrac{1}{2}\left(-t\indices{_\rho }R\indices{_\lambda _\mu _\nu ^\sigma }t\indices{_\sigma }+t\indices{_\lambda }R\indices{_\rho _\mu _\nu ^\sigma }t\indices{_\sigma }\right) &= \left(t\indices{_[_\rho }\nabla \indices{_\lambda _]}\kappa \right)t\indices{_\mu }\\
  \Leftrightarrow t\indices{^\nu }t\indices{_[_\rho }R\indices{_\lambda _]_\nu _\mu ^\sigma }t\indices{_\sigma }+t\indices{^\nu }t\indices{_[_\lambda }R\indices{_\rho _]_\mu _\nu ^\sigma }t\indices{_\sigma } &= \left(t\indices{_[_\rho }\nabla \indices{_\lambda _]}\kappa \right)t\indices{_\mu }\\
  \Leftrightarrow t\indices{^\nu }\dfrac{1}{2}\left(-t\indices{_\rho }R\indices{_\nu _\mu _\lambda ^\sigma }t\indices{_\sigma }+t\indices{_\lambda }R\indices{_\nu _\mu _\rho ^\sigma }t\indices{_\sigma }\right) &= \left(t\indices{_[_\rho }\nabla \indices{_\lambda _]}\kappa \right)t\indices{_\mu } \text{todo C.3.6}\\
  \Leftrightarrow t\indices{^\nu }R\indices{_\nu _\mu _[_\lambda ^\sigma }t\indices{_\rho _]}t\indices{_\sigma } &= 
\end{align} 
