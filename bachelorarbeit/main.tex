...
\begin{align} 
   \dfrac{\text{D}}{\td \lambda }\diff[]{x^\nu }{\lambda }:=\diff[]{x^\mu }{\lambda }\nabla _\mu \diff[]{x^\nu }{\lambda }=\diff[2]{x^\mu }{\lambda }+\Gamma _{\rho \sigma}^\mu \diff[]{x^\rho }{\lambda }\diff[]{x^\sigma }{\lambda }=0\label{eq:geodesics equation}
,\end{align} 
...
It is given by
\begin{align} 
  M_\text{irr} &= \sqrt{\dfrac{A}{16\pi G^2}} \text{\todo{show this, see christodoulou 1970}}
,\end{align} 
