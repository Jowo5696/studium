...
\todo{stationary limit surface, ergosphere, outer event horizon, inner event horizon}
%}}}
...
Since these are sufficient to describe every black hole as states by the no-hair or uniqueness theorem, we should be able to find a relation, which characterizes how each quantity changes in relation to the other quantities.

Consider the Penrose-Process 
