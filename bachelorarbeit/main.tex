...
first conjecture by bekenstein.}
...
%{{{ Kerr Black Holes and Penrose Process
...
%{{{ Generalised Zeroth, First and Third Law of Thermodynamics
\section{Generalised Laws of Thermodynamics}
\textit{Carroll} 
