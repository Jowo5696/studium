...
\begin{align} 
        y_{lm}\left(\theta ,\varphi \right)&:=\,\sqrt[]{\dfrac{2l+1}{4\pi }\dfrac{\left(l-m\right)!}{\left(l+m\right)!}}P_l^m \left(\cos \varphi \right)\text{e}^{\text{i}m\varphi }
,\end{align} 
