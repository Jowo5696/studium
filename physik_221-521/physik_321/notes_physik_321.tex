...
\subsection{Mittlere Quelldichte und Satz von \textsc{Gauss}}
...
\begin{align} 
        \,\text{div}\,\vv{E}\left(\vv{r}\right)&=\dfrac{\rho \left(\vv{r}\right)}{\varepsilon _0}\\
...
.\end{align} 
Sei ein geschlossener Weg in der $xy$--Ebene mit Mittelpunkt $\vv{r}_0$. Die Fläche ist $F=\Delta x\Delta y$ und die Normale $\vv{n}=\vv{e}_z$ 
\begin{align} 
...
\begin{align} 
        \lim_{\Delta x,\Delta y\rightarrow 0}\dfrac{Z}{F}&=\left(\partial _xa_y\left(\vv{r}_0\right)-\partial _ya_x\left(\vv{r}_0\right)\right)\\
