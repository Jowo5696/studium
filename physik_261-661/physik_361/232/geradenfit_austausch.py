...
class Auswertung:
    ...
    def auswertung(self):
        ...
        for i in range(len(self.x)):
            ...
            plt.errorbar(self.x[i],self.y[i],self.yerr[i],self.xerr[i],fmt=self.color,ls="",marker=".",label=self.label[i])
            plt.plot(self.x[i],fit,self.color,label=self.label[i]+' Geradenfit')
